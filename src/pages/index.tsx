  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="¡Sé un pionero en el mercado y genera ingresos extras con toda la tecnología necesaria para facilitar los pagos crypto! Descubre el futuro del comercio en  línea con nuestra plataforma blockchain."
        />
